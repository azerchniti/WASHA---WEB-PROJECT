...
<?php $producttype=$_GET['producttype'];?>
        ...
        <form action="" method="GET">
          <div class="p-1 bg-light rounded rounded-pill shadow-sm mb-4">
            <div class="input-group">
              ...
              <input type="hidden"  type="text" name="producttype" id="producttype" placeholder="search" value="<?php echo $producttype ; ?>" aria-describedby="button-addon1" class="form-control border-0 bg-light">
...
<?php
    ...
    $query = "SELECT * FROM product WHERE  nameproduct LIKE '%" . $name . "%' AND  producttype LIKE $producttype     LIMIT $starting_limit,$perPage ";
...
/* if ($user['producttype']==$_GET['producttype']) { */
?>
...
<div class="container"> <ul class="pagination">
  <?php if($page==1){ ?>
<li class="page-item disabled"><a class="page-link"  <?php $page--;?>href="category_order.php?page=<?php echo $page;  ?>&producttype=<?php echo $producttype;  ?>">Previous</a></li>
<?php } 
else { ?>
<li class="page-item" ><a class="page-link"  <?php $page--;?>href="category_order.php?page=<?php echo $page;  ?>&producttype=<?php echo $producttype;  ?>">Previous</a></li>
<?php }?> 
 <?php 
 if(($nb==6)||(($nb!=6)&&($searchfound==0))){
 for ($page = 1; $page <= $total_pages ; $page++):?>
       <li class="page-item"> <a href="category_order.php?page=<?php echo $page;  ?>&producttype=<?php echo $producttype;  ?>" class="page-link"> <?php  echo $page; ?></a></li>
    <?php endfor; 
    } 
    ?>
  <?php if($test==$total_pages){ ?>
<li class="page-item disabled"><a class="page-link"  <?php $test++;?> href="category_order.php?page=<?php echo $test;  ?>&producttype=<?php echo $producttype;  ?>">Next</a></li>
<?php } 
else { ?>
<li class="page-item" ><a class="page-link"  <?php $test++;?> href="category_order.php?page=<?php echo $test;  ?>&producttype=<?php echo $producttype;  ?>">Next</a></li>
<?php }?>   </ul> </div> 
    <?php } ?>
