...
<form  id="create-account-form" method="POST">
            ...
            <input type="text" name="nameproduct" id="nameproduct" maxlength="20" placeholder="Enter the name of the product" style="width: 40%;height: 40px;" >   
            <p>Error Message</p>
            
            </div>
            <label for="price">Price </label>
            <div class ="input-group">
            <input type="number"  step="0.1" name="price" id="price"  maxlength="20" placeholder="Enter the price of the product" style="width: 40%;height: 40px;">
 <p>Error Message</p>
            </div>
    ...
    <label for="discription">
      ...
      <div class ="input-group">
      <textarea type="text" name="discription" id="discription"  cols="60%" rows="5" placeholder="Enter the description of the product"> </textarea>
      </div>
    ...
    ?>
            ...
            <div class ="input-group">
            <input align="right" type="number"  name="quantity" id="quantity" placeholder="Enter the quantity of the product" style="width: 40%;height: 40px;">
...
<div class="container">
  <div class="text-center">
      ...
      <div class="file-loading">
        <input  id="input-ficons-5" type="file" accept="image" name="img"  >
      </div>
...
<!--       <button type="submit" class="btn btn-success">Submit</button>
 ...
 <div class="button-container-div">
  <input class="btn btn-success" id="submit" name="submit" type="submit" value="Add the product">
...
<!-- </div>
 -->
 <div class="button-container-div">
    <button class="btn btn-primary mt-2" href="listproduct.php">Back to list</button>
</div>

<script>
const form = document.getElementById('create-account-form');
const usernameInput = document.getElementById('nameproduct');
const emailInput = document.getElementById('price');
const confirmPasswordInput = document.getElementById('quantity');
...
function validateForm() {
    ...
    if(usernameInput.value.trim()==''){
        setError(usernameInput, 'Product name can not be empty');
    }else if(usernameInput.value.trim().length <3 || usernameInput.value.trim().length > 50){
        setError(usernameInput, 'Name must be min 3 and max 50 charecters');
    }else {
        setSuccess(usernameInput);
    }
    //EMAIL
    if(emailInput.value.trim()==''){
        setError(emailInput, 'Price can not be empty');
    }else if(emailInput.value<0){        
        setError(emailInput, 'Please enter a positive value');
    }else{        
    ...
    if(confirmPasswordInput.value.trim()==''){
        setError(confirmPasswordInput, 'Quantity can not be empty');
    }else if(confirmPasswordInput.value<0){
        setError(confirmPasswordInput, 'Please enter a positive value');
    }else {
